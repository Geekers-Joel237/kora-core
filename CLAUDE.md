...
- `docs/adr/` — ADR-001 immutable ledger and balance cache · ADR-002 payment lifecycle and locking · ADR-003 single-call payment API · ADR-004 micro-transaction model · ADR-005 load-test calibration · ADR-006 compose topology · ADR-007 closed enumeration enforcement

...
public record CashInRequest(
    ...
    public CashInCommand toCommand(Id customerId, Id correlationId) {
        return new CashInCommand(correlationId, customerId, Pin.of(rawPin), new Amount(amount, currency),
